...
# Setting snap raster
Snap.Raster <- raster("/Users/maclark/Desktop/SSA_Ag_Rasters/Crop_2010_SSA.tif")/100
...
raster.list <- list.files("/Users/maclark/Desktop/SSA_Ag_Rasters/BAU/",
                          pattern = "mean.tif",
                          full.names = TRUE)
raster.list <- raster.list[grep("Crop",raster.list)]
raster.list <- raster.list[-grep("Delta", raster.list)]
# Getting 2010 raster file name
crop_2010 <- "/Users/maclark/Desktop/SSA_Ag_Rasters/Crop_2010_SSA.tif"
...
for(i in c(length(raster.list),1:10)) {
  # Checking progress
  ...
  #             "/Users/maclark/Desktop/SSA_Ag_Rasters/Outputs/ESH_Birds_BAU_Crop_2060.csv",
  #             row.names = FALSE)
  # }
  ...
  #   write.csv(esh.table.tmp,
  #             "/Users/maclark/Desktop/SSA_Ag_Rasters/Outputs/ESH_Birds_BAU_Crop_2010.csv",
  #             row.names = FALSE)
  # }
...
# And writing csv
write.csv(esh.table,
          "/Users/maclark/Desktop/SSA_Ag_Rasters/Outputs/ESH_Birds_BAU_Crop.csv",
          row.names = FALSE)
